...
public class MainActivity extends AppCompatActivity {
    ...
    private ShoppingBasketFragment2 SBF2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportFragmentManager().beginTransaction().replace(R.id.main_content, HF).commit();
        //메뉴 바 설정
        settingSideNavBar();
    }
    ...
    public void settingSideNavBar() {
        ...
        SBF2 = new ShoppingBasketFragment2();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem nav_item) {
                switch(nav_item.getItemId()) {
                    ...
                    case R.id.navigation_3: //장바구니
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.main_content, SBF2).addToBackStack(null).commit();
                        return true;
...
//            getSupportFragmentManager().beginTransaction().hide(SF).commit();
//        }
//    }
}
