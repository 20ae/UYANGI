...
public class FavoriteActivity extends AppCompatActivity {
    ...
    private static String LOG = "FavoriteActivity";
...
//
//        lv = (ListView) findViewById(R.id.lvFavorite);
//
//
...
//        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(FavoriteActivity.this, postData, new AsyncResponse() {
//            @Override
...
//
//
//                        PostResponseAsyncTask taskRemove = new PostResponseAsyncTask(FavoriteActivity.this,
...
//                                    Toast.makeText(FavoriteActivity.this, "Item Removed", Toast.LENGTH_SHORT).show();
//
//                                }
//                            }
//                        });
...
//                });
//
//                adapter = new FunDapter<>(FavoriteActivity.this, favoriteList, R.layout.favorite_row, dic);
//                adapter.notifyDataSetChanged();
...
//        taskRead.execute(url);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //searchView = (SearchView) menu.findItem(R.id.main_menu1);
    ...
    public void settingSideNavBar() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.main_content, FF).addToBackStack(null).commit();
