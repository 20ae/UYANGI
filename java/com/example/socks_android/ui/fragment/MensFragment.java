...
public class MensFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabLayout.addTab(tabLayout.newTab().setText("남성중목양말"));
        tabLayout.addTab(tabLayout.newTab().setText("남성발목양말"));
        tabLayout.addTab(tabLayout.newTab().setText("남성덧신"));
        tabLayout.addTab(tabLayout.newTab().setText("남성스포츠,두툼양말"));
        tabLayout.addTab(tabLayout.newTab().setText("남성프리미엄양말"));
    ...
    private class CustomAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    MensMainFragment main = new MensMainFragment();
                    return main;
                case 1:
                    MensMiddleFragment middle = new MensMiddleFragment();
                    return middle;
                case 2:
                    MensAnkleFragment ankle = new MensAnkleFragment();
                    return ankle;
                case 3:
                    MensFakeFragment fake = new MensFakeFragment();
                    return fake;
                case 4:
                    MensSportsFragment sports = new MensSportsFragment();
                    return sports;
                case 5:
                    MensPremiumFragment premium = new MensPremiumFragment();
                    return premium;
                default:
                    return null;
            }
